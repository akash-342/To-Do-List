...
// Get the toggle button and the current theme
...
if (currentTheme === 'dark') {
    ...
    darkModeSwitch.textContent = '☀️';  // Set to light mode icon
}  
...
darkModeSwitch.addEventListener('click', function() {
    ...
    document.getElementById('category').classList.toggle('dark-mode');
    
    // Apply dark mode to all category cards
    document.querySelectorAll('.category').forEach((category) => {
        category.classList.toggle('dark-mode');
    });

    // Apply dark mode to the Add Task button and form
    document.querySelector('.add-task-btn').classList.toggle('dark-mode');
    document.querySelector('.add-task').classList.toggle('dark-mode');
    document.querySelectorAll('.add-task input, .add-task select').forEach((input) => {
        input.classList.toggle('dark-mode');
    });
    document.querySelectorAll('.add-btn, .cancel-btn').forEach((btn) => {
        btn.classList.toggle('dark-mode');
    });

    // Change the button text based on the current theme
    if (document.body.classList.contains('dark-mode')) {
        darkModeSwitch.textContent = '☀️';  // Light mode icon
        localStorage.setItem('theme', 'dark');  // Save preference
    } else {
        darkModeSwitch.textContent = '🌙';  // Dark mode icon
